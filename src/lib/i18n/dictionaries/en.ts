...
export const en = {
  ...
  companiesPage: {
    eyebrow: "Companies",
    title: "companies",
    subtitle: "Accounts shared by the team. Contacts are linked by company.",
  ...
  companyRecord: {
    ...
    notFoundBody: "The company you're looking for doesn't exist.",
  ...
  companyForm: {
    ...
    errorMissingName: "Enter a company name first.",
    errorDuplicate: "A company with that name already exists.",
  },
