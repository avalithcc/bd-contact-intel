...
export const en = {
  ...
  migration: {
    ...
    historyWhen: "When",
    sectionHubspotTitle: "HubSpot import",
    hubspotReportTitle: "HubSpot import",
    tableHubspotNew: "New contacts",
    tableHubspotReview: "Flagged for review",
    tableHubspotSkippedOwnCompany: "Own-company skipped",
    tableHubspotNoCompany: "No company resolved",
    tableHubspotCompaniesMatchedByCompact: "Companies linked by approximate name",
    tableHubspotAmbiguousCompactMatches: "Ambiguous approximate matches (created anyway)",
    compactMatchesReviewTitle: "Companies linked by approximate name — review",
    compactMatchesReviewEmpty: "No approximate matches in this run.",
    compactMatchesIncoming: "HubSpot company",
    compactMatchesExisting: "Linked existing company",
    tableHubspotOwnersMapped: "Mapped to an owner",
    tableHubspotOwnersUnassigned: "Unassigned",
    tableHubspotOwnersUnknown: "Unknown owner in HubSpot",
    tableHubspotContacted: "Retroactive activity: contacted",
    tableHubspotReplied: "Retroactive activity: replied",
    tableHubspotDiscarded: "Retroactive activity: discarded",
    tableHubspotUnknownLeadStatusesTitle: "Unmapped lead statuses",
    tableHubspotUnknownLeadStatusesEmpty: "No unmapped statuses in this run.",
    ...
    approveErrors: {
      ...
      review_threshold_unconfirmed: "Confirm the review checkbox before approving this run.",
    },
  },
  ...
  contactList: {
    ...
    filterIndustryAny: "All",
    filterSeniorityLabel: "Seniority",
    filterSeniorityAny: "All",
    filterEmailStatusLabel: "Email status",
    filterEmailStatusAny: "All",
  ...
  contactsImport: {
    ...
    connectionsFileLabel: "Connections.csv file",
    connectionsSubmit: "Import",
    connectionsImporting: "Importing…",
    connectionsErrorMissingFile: "Choose a CSV file.",
    ...
    outcomeNew: "New contacts",
    outcomeSkippedOwnCompany: "Skipped · own company",
