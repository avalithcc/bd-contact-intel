...
export const es: typeof en = {
  ...
  contactRecord: {
    ...
    tabOverview: "Resumen",
    aboutSectionTitle: "Sobre este contacto",
    propEmail: "Correo electrónico",
    propJobTitle: "Cargo",
    ...
    quickActionTask: "Tarea",
    quickActionMeeting: "Reunión",
    quickActionDiscard: "Descartar",
    quickActionSignal: "Pegar señal",
    notePlaceholder: "Agregar una nota sobre este contacto…",
    ...
    errorGmailUnavailable: "No se pudo enviar el correo. Intentar de nuevo más tarde.",
    gmailReconnectLink: "Ir a Cuenta › Correo",
    ...
    meetingSubmit: "Registrar reunión",
    meetingHelp: "Al guardar, el estado derivado pasa a Reunión.",
    discardReasonLabel: "Motivo (obligatorio)",
    discardReasonPlaceholder: "Elegir un motivo…",
    discardNoteLabel: "Nota",
    discardNoteRequiredHint: "Detallar el motivo es obligatorio cuando se elige «Otro».",
    discardSubmit: "Descartar contacto",
    discardReasonWrongProfile: "No es el perfil adecuado",
    discardReasonNotInterested: "Sin interés",
    discardReasonOtherVendor: "Ya trabaja con otro proveedor",
    discardReasonLeftCompany: "Dejó la empresa",
    discardReasonBadData: "Datos incorrectos o desactualizados",
    discardReasonOther: "Otro",
    ...
    connectedOnPrefix: "Conectado el",
    connectionHistoryNone: "Sin historial de conversaciones",
    connectionHistorySomePrefix: "mensajes · último",
    viewConversationLink: "Ver conversación",
    viewConversationAuditHint: "Queda registrada en el registro de auditoría",
    timelineFilterGroupLabel: "Filtrar por tipo de actividad",
  ...
  migration: {
    ...
    historyWhen: "Cuándo",
    sectionHubspotTitle: "Importación de HubSpot",
    hubspotReportTitle: "Importación de HubSpot",
    tableHubspotNew: "Contactos nuevos",
    tableHubspotReview: "Marcados para revisión",
    tableHubspotSkippedOwnCompany: "Empresa propia omitida",
    tableHubspotNoCompany: "Sin empresa resuelta",
    tableHubspotCompaniesMatchedByCompact: "Empresas vinculadas por nombre aproximado",
    tableHubspotAmbiguousCompactMatches: "Coincidencias aproximadas ambiguas (se crearon igual)",
    compactMatchesReviewTitle: "Empresas vinculadas por nombre aproximado — revisar",
    compactMatchesReviewEmpty: "No hay coincidencias aproximadas en esta corrida.",
    compactMatchesIncoming: "Empresa de HubSpot",
    compactMatchesExisting: "Empresa existente vinculada",
    tableHubspotOwnersMapped: "Asignados a un responsable",
    tableHubspotOwnersUnassigned: "Sin responsable",
    tableHubspotOwnersUnknown: "Responsable desconocido en HubSpot",
    tableHubspotContacted: "Actividad retroactiva: contactado",
    tableHubspotReplied: "Actividad retroactiva: respondió",
    tableHubspotDiscarded: "Actividad retroactiva: descartado",
    tableHubspotUnknownLeadStatusesTitle: "Estados de lead sin mapear",
    tableHubspotUnknownLeadStatusesEmpty: "No hay estados sin mapear en esta corrida.",
  ...
  duplicates: {
    ...
    subtitle: (openCount: number) => `${openCount} abiertos`,
    ...
    recommendationNote: (survivorLabel: string) =>
      `Al fusionar, la Ficha ${survivorLabel} sobrevive. En cada campo, gana el valor más completo; los valores descartados quedan en el historial de fusión.`,
    mergeButton: (survivorLabel: string) => `Fusionar en ${survivorLabel}`,
    notDuplicateButton: "No es duplicado",
    noValue: "—",
    historyTitle: "historial de fusiones",
    historyContact: "Contacto fusionado",
  ...
  contactList: {
    ...
    filterIndustryAny: "Todas",
    filterSeniorityLabel: "Seniority",
    filterSeniorityAny: "Todos",
    filterEmailStatusLabel: "Estado del correo",
    filterEmailStatusAny: "Todos",
    filterStatusLabel: "Estado",
    filterStatusAny: "Todos",
    filtersApply: "Aplicar filtros",
    filtersClear: "Quitar filtros",
    ...
    saveViewHelp: "Vista personal. Las vistas de equipo (Todos los contactos, Mis contactos, Sin contactar, Con vacantes abiertas, Listos para Outreach) están definidas por el producto.",
    save: "Guardar",
    cancel: "Cancelar",
