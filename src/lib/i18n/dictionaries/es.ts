...
export const es: typeof en = {
  ...
  contactRecord: {
    ...
    timelineComingSoon: "La cronología de actividad filtrable estará disponible en la Fase 10.",
    associationsComingSoon: "Las asociaciones completas estarán disponibles en la Fase 11.",
