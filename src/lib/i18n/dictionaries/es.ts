...
export const es: typeof en = {
  ...
  companiesPage: {
    ...
    colStage: "Etapa",
    colNotes: "Notas",
    colRevenue: "Potencial de ingresos",
    stageProspect: "Prospecto",
    stageQualified: "Calificada",
    stageProposalSent: "Propuesta enviada",
    stageWon: "Ganada",
    stageLost: "Perdida",
    emptyState: "Todavía no hay empresas",
    createLink: "+ Agregar empresa",
    previous: "Anterior",
    next: "Siguiente",
  },

  companyRecord: {
    backLink: "← Volver a empresas",
    notFoundTitle: "Empresa no encontrada",
    notFoundBody: "La empresa que buscás no existe.",
    revenuePotential: "Potencial de ingresos",
    notesTitle: "Notas",
    ...
    stageLabel: "Etapa",
    stageNone: "Ninguna",
    revenueLabel: "Potencial de ingresos",
    notesLabel: "Notas",
    save: "Guardar",
    saving: "Guardando…",
    cancel: "Cancelar",
    editError: "No se pudo actualizar la empresa",
    editSuccess: "Empresa actualizada.",
    addActivityDialogTitle: "Agregar actividad",
    notePlaceholder: "¿Qué pasó?",
    addActivityError: "No se pudo agregar la actividad",
    addActivitySuccess: "Actividad agregada.",
  },
  ...
  companyForm: {
    ...
    errorMissingName: "Ingresá un nombre de empresa primero.",
    errorDuplicate: "Ya existe una empresa con ese nombre.",
  },
